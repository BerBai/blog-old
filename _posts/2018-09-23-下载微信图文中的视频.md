...
- 复制视频 url 地址到新窗口打开，如下图
  ...
  ![视频获取](https://ws1.sinaimg.cn/large/006KCUaNgy1fvjupqp197j30es0but9z.jpg)
...
- 安装过 IDM 的，在浏览器中会有一个 IDM浮窗 很方便就可以下载，同时视频播放前的广告也会被 IDM 捕捉，下载时看清楚即可。
  ...
  ![IDM浮窗](https://ws1.sinaimg.cn/large/006KCUaNgy1fvjurm5m21j30iy0jbtaq.jpg)

###### 抓包

- 在之前的视频界面按 `F12` 打开浏览器的控制台，选择 `Network` ，播放视频，在右边栏找到视频地址即可。

  ![视频直链](https://ws1.sinaimg.cn/large/006KCUaNgy1fvjus8qpisj311y0jh41r.jpg)
...
![柏战不殆](https://ws1.sinaimg.cn/large/006KCUaNgy1fvjusob2j8j30go05kgpt.jpg)  
